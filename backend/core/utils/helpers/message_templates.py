...
class MessageTemplates:
    ...
    def subscription_renewal_reminder(plan_name: str, renewal_date: str):
        return f"""
            <p>
                Your NutriLens {plan_name} subscription renews on {renewal_date}.
    ...
    def subscription_payment_failed(plan_name: str, grace_end: str):
        return f"""
            <p>
                We could not renew your NutriLens {plan_name} subscription.
    ...
    def subscription_expired(plan_name: str):
        return f"""
            <p>
                Your NutriLens {plan_name} subscription period has ended and we
    ...
    def subscription_grace_expired(plan_name: str):
        return f"""
            <p>
                Your NutriLens {plan_name} subscription grace period has ended.
