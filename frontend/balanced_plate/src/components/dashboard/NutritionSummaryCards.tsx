          ...
          <div className="flex justify-center gap-3 mb-6">
            {cardConfig.map((card, idx) => {
              ...
              return (
                <div
                  key={card.key}
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${card.gradient} flex items-center justify-center opacity-${80 - idx * 15}`}
...
{/* Header */}
            <div className="relative flex items-center justify-between mb-3">
              <div className={`w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-br ${card.gradient} flex items-center justify-center transition-transform group-hover:scale-110 group-hover:rotate-3`}>
