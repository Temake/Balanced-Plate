...
import { CookingPot, Bell, Sparkles, ChefHat, Clock, Heart } from 'lucide-react'
...
const Recipes = () => {
  ...
  const handleNotify = () => {
    ...
    toast.success("You'll be notified when Recipes is ready!")
  }
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="max-w-lg w-full text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg mb-8 leading-relaxed">
            Discover thousands of nutritionist-approved recipes tailored to your dietary 
            ...
            {!isSubscribed ? (
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
                <Button 
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            {[
              { icon: ChefHat, label: "Chef Curated", desc: "Expert recipes" },
              { icon: Clock, label: "Quick Meals", desc: "Under 30 mins" },
              { icon: Heart, label: "Personalized", desc: "For your goals" },
            ].map((feature, i) => (
              <div key={i} className="p-4 rounded-xl bg-white/50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700">
                <feature.icon className="w-6 h-6 mx-auto mb-2 text-orange-500" />
