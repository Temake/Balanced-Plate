  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex flex-col">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex-grow">
            <div className=" flex lg:flex-col-span-2 space-y-1">
            
         
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg m-2 sm:m-4 lg:m-6 p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  {chartType === 'bar' ? (
                    ...
                    <PieChart>
                      ...
                      <Tooltip 
                        formatter={(value: number, props: { payload: FoodClassData }) => [`${value} items (${props.payload.percentage}%)`, props.payload.foodClass]}
                      />
                    </PieChart>
                  ) : (
